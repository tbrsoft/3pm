...
#define MyAppVerName "3PM Kabalin 6.5"
...
Source: "H:\ahora\3PMv65 Kabalin\pub\LEER.txt"; DestDir: "{app}\PUB"; Flags: ignoreversion
Source: "H:\ahora\3PMv65 Kabalin\Nev.man"; DestDir: "{sys}"; Flags: restartreplace uninsneveruninstall sharedfile
Source: "H:\ahora\3PMv65 Kabalin\manual.doc"; DestDir: "{app}"; Flags: ignoreversion
Source: "H:\ahora\3PMv65 Kabalin\repair 3PM\repair.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "H:\ahora\3PMv65 Kabalin\ini.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Archivos de programa\Inno Setup 5\vbFiles\other\tbrerr.dll"; DestDir: "{sys}\tbrlib"; Flags: restartreplace sharedfile regserver
...
Source: "H:\ahora\3PMv65 Kabalin\3PM.EXE"; DestDir: "{app}"; Flags: ignoreversion
